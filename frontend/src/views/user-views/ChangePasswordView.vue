<template>
    <div class="d-flex justify-content-center align-items-center vh-100 bg-dark text-white" >
        <BForm class="d-flex flex-column justify-content-center align-items-center" @submit="onSubmit" @reset="onReset">
            <BFormGroup id="input-group-1" label="E-mail:" label-for="input-1" class="mb-4">
                <BFormInput id="input-1" v-model="form.email" type="email" placeholder="Digite o e-mail" required />
            </BFormGroup>

            <BFormGroup id="input-group-3" label="Nova Senha:" label-for="input-2" class="mb-4">
                <BFormInput id="input-3" v-model="form.password" type="password" placeholder="Digite a nova senha"
                    required />
            </BFormGroup>
